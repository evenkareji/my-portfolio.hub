        ...
        <Box w={{ base: '100%', md: 600 }} pb={50}>
          <PostBodyCss>
            ...
            <p>
              ...
              え？抽象度たかすぎ？デュフっ
              <br />
              プロダクションレディなSNSや、かっこいい動きをするWebサイトを今は作りたいと思っています。
              ありすぎるんですよねぇ正直。Densoのスライドショーとか、某アクアリングさんのWebサイトのあのアクアのリングとか、Web系
              知らない友達に見せてもすごすごいゆーてました。 僕もそう思いますっ
            </p>
            <p></p>
            <h3>Web制作における興味関心</h3>
            <p>
            ...
            <div>
              <p>
                ...
                {/* 初めましてで出てくる顔面がまさしく僕たちが作るWebサイト、すなわち顔面なのである。
                そういう意味で言えば、我々はデジタル整形外科で働いているということなのだ。
                ふざけすぎた、怒られそう... */}
