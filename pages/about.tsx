      ...
      <Inner>
        <Box w={{ base: '100%', md: 600 }} pb={50}>
          <PostBodyCss>
            ...
            <br />
            <p>
              当初はフロントエンドに学習を集中させる手筈でしたが、GPTに触れていく過程で、プロンプトエンジニアが一過性のブームであるという認識はなくなりました
              <br />
              <br />
            ...
            <p>
              ...
              <br />
              <br />
              その間にデザインも勉強しようと思い、まず手始めにお絵描きを1日1時間して、モンスターしか描けなかった僕が、夏休みが終わった時には絵がうまくなってて友達が驚いてくれました。嬉しかったです！
              <br />
              <br />
              <Image src={Goat} alt="Goat" />
              <Image src={Cat} alt="Cat" />
              <br />
              <br />
              あとはデザイン系の本もちょくちょく読み始め、この1年では4冊ほど読みました。デザインの知識だけは同級生に負けていない自信があります。読めよと言われた本は必ず読みました。
              <br />
              <br />
              このサイトも自分で作りまして、友達には「最初はデザインのセンスが一人だけ壊滅的だったのにめちゃめちゃ成長したな」と言われ頑張った甲斐があったと思いました！
              <br />
              <br />
              <Image src={Design} alt="デザインブック" />
              <br />
              <br />
            ...
            <h3>
              9月~10月　ReactでECサイトを作る。blogサイトを作りながらバニラJSをより理解していく
            </h3>
            <p>
              Reactを学んだ後のアウトプットとしてECサイトを作りましたが、ハードルが高く学習を途中で中断しました
              「実践Webアプリケーション開発」という書籍で作ってみたのですが、上級者向きで、いきなりのアウトプットには向いていなかったなと思いました。
              <br />
              <br />
            ...
            <p>こちらに関しましては、この記事を読んでいただけると幸いです</p>
            ...
            <p>
              ...
              ですが強いていうなら、SNSを作り始める直前が一番きつかったと思います
              <br />
              <br />
              atomic
              designというコンポーネント設計思想を使うことが初めてで、変に分割したら、壊れないか？など独学だからこそ予測できない不安感がありました。1ヶ月かけて作ったのに全て無にに記すのではないかと不安に駆られることもあり、踏み出す勇気がいりました。またNode.js自体2週間しか学習していなかったので、うまく理解していいね機能とか、そもそも投稿機能ですら実装できるかとか不安が割とありました
              <br />
              <br />
              でも、不安には負ず踏み出し、完成まで持って行きました。先生も勉強してない範囲なので完全に独力で全てを解決してできて、一人でやってける自信もより一層つきました
              <br />
              <br />
              <Image src={All} alt="すべての本" />
              以上計7ヶ月でSNSの基盤を作り上げた流れになります
            </p>
            <h3>残った学生生活でしたいこと</h3>
            <p>
              以降はchatgptなどを使って自分のSNSに取り入れたりと新しい技術を積極的に学び、自分のサービスに活かせないかと模索していきたいです。現状では、誹謗中傷を感知し、事前にその言葉を別の言葉に置き換える機能を実装しています。あとは、自分で営業してWebサイトを作ってお金をもらったり、勉強会で知り合ったエンジニアの方々を誘って
              SNSを完成させリリースまで持っていきたいです！
              <br />
              <br />
